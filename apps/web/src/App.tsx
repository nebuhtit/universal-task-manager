...
export default function App() {
  ...
  const activeDateLabel = `${wallClock.toLocaleDateString(undefined, { weekday: 'long', month: 'long', day: 'numeric' })} · ${wallClock.toLocaleTimeString(undefined, { hour: '2-digit', minute: '2-digit', second: '2-digit' })}`;
