...
if (await exists('apps/web/dist-native/index.html')) {
  if (await exists('apps/web/dist-native/sw.js') || await exists('apps/web/dist-native/manifest.webmanifest')) throw new Error('Native iOS must not include a browser service worker or PWA manifest');
}
