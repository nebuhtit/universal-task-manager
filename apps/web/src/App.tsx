...
import {
  APP_VERSION, backfillItemCreationVersions, collectScheduledEvents, compileQuery, createId, createItem, evaluateFormulas, makeSeries,
  ...
  return <div className="modal-backdrop" role="presentation" onMouseDown={(event) => event.target === event.currentTarget && onClose()}>
    <section className="drawer" role="dialog" aria-modal="true" aria-label="Item editor">
      ...
      <div className="editor-scroll">
        ...
        <details><summary>System metadata</summary><div className="details-body metadata-grid"><div><span>Created with</span><output>v{item.createdWithVersion}</output></div><div><span>Schema</span><output>{item.schemaVersion}</output></div><div><span>Item ID</span><output>{item.id}</output></div></div></details>
      </div>
