...
const en = {
  ...
  Calendar: 'Календарь', Today: 'Сегодня', Tomorrow: 'Завтра', 'This week': 'Эта неделя', 'Next week': 'Следующая неделя', 'Next N days': 'Следующие N дней', 'Custom period': 'Произвольный период', 'Calendar settings': 'Настройки календаря', 'Show weekends': 'Показывать выходные',
