...
const en = {
  ...
  'Schedule in period': 'Расписание в периоде', 'Schedule period': 'Период расписания', 'Match any': 'Любое условие', 'Include overdue': 'Включая просроченные', 'Number of days': 'Количество дней', 'Custom period starts': 'Начало периода', 'Custom period ends': 'Конец периода', 'Schedule dates to match': 'Проверяемые даты расписания',
