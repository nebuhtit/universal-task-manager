...
Object.assign(extraTranslations.ru, {
  ...
  Statistics: 'Статистика', 'Show time statistics': 'Показывать статистику по времени', 'Always subtract scheduled items': 'Всегда вычитать запланированные элементы', 'Reserved items': 'Постоянные элементы', 'Search items': 'Поиск элементов', 'Search reserved items': 'Поиск постоянных элементов', 'No matching items.': 'Совпадений нет.',
  'Capacity period:': 'Период расчёта:', 'Free time unavailable: add one finite Schedule in period rule.': 'Свободное время недоступно: добавьте одно конечное условие «Расписание в периоде».', 'Free time is the whole period minus this view\'s planned Duration and the reserved items below.': 'Свободное время — это весь период за вычетом запланированной длительности элементов вида и выбранных ниже постоянных блоков.', 'No scheduled items with Duration yet.': 'Пока нет запланированных элементов с длительностью.', '· repeats': '· повторяется',
